...
class AboutPageTests(SimpleTestCase):
    ...
    def test_aboutpage_contains_no_incorrect_html(self):
        self.assertNotContains(self.response, "Miley Cyrus is an icon")

    def test_aboutpage_url_resloves_homepageview(self):
        view = resolve("/about/")
